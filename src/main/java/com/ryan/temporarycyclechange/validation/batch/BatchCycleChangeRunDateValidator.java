 ...
 * @author rsapl00
 */
public class BatchCycleChangeRunDateValidator extends Validator {

    public BatchCycleChangeRunDateValidator(CycleChangeRequestRepository repository) {
        super(repository);
    }

    public BatchCycleChangeRunDateValidator(CycleChangeRequestRepository repository, Validator validator) {
